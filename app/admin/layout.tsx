...
export default async function AdminLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-white/80 py-8 px-4">
      <div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden border">
        <div className="grid grid-cols-[220px_1fr]">
          <aside className="border-r p-6 bg-white">
          ...
          <main className="p-6 bg-white/0">{children}</main>
        </div>
      </div>
    </div>
  );
